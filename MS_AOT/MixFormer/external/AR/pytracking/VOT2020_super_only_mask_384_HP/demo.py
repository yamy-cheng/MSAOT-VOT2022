...
mask_path = '/home/yoxu/vot_2022/aot/datasets/vot_demo/masks/agility/00000001.png'
image_path = '/home/yoxu/vot_2022/aot/datasets/vot_demo/images/agility/00000001.jpg'

image = cv2.cvtColor(cv2.imread(image_path), cv2.COLOR_BGR2RGB)  # Right
...
seq_root = '/home/yoxu/vot_2022/aot/datasets/vot_demo/images/agility'
seq_root = sorted(seq_root[1:])


for img_name in seq_root:
    img_path = os.path.join(img_name, seq_root)
    image = cv2.cvtColor(cv2.imread(img_path), cv2.COLOR_BGR2RGB)  # Right
