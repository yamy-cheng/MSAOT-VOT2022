...
class MultiRestrictSize_(object):
    def __init__(self,
                 max_short_edge=None,
                 max_long_edge=800,
                 flip=False,
    ...
    def __call__(self, sample):
        ...
        for scale in self.multi_scale:
            # restrict short edge
            sc = 1.
            if self.min_short_edge is not None:
                if h > w:
                    short_edge = w
                else:
                    short_edge = h
                if short_edge < self.min_short_edge:
                    sc *= float(self.min_short_edge) / short_edge
            new_h, new_w = sc * h, sc * w
...
class MultiRestrictSize_2(object):
    def __init__(self,
                 max_short_edge=None,
                 max_long_edge=800,
                 flip=False,
